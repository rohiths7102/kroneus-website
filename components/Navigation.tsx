...
const SELAHyperTunnelGame = dynamic(() => import('./game/SELAHyperTunnelGame'), { ssr: false })
...
export default function EnterpriseNavigation() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-28">
            <a 
              ...
              className="flex items-center space-x-4 group relative z-50 cursor-pointer"
            >
              <motion.div
      ...
      {/* Game Overlay */}
      {isGameOpen && (
        <GameErrorBoundary onError={() => setIsGameOpen(false)}>
          <SELAHyperTunnelGame onClose={() => setIsGameOpen(false)} />
        </GameErrorBoundary>
      )}
    </>
  )
